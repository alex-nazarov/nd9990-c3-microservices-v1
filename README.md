...
This repository is solution for Cloud Developer ND - Course 03 - Monolith to Microservices. 
...
### 4. Docker Desktop
Project will require to install Docker Desktop to create containers for individual microservices. Refer the following links for instructions 
...
### 5. Kubernetes 
Project is intended to run in Kubernetes cluster, one of kubernetes clusters need to be configured - KubeOne / Minikube / kubectl on top of Docker Desktop. Refer - 
...
### 6. Travis CI
Repository is monitored with Travis CI.